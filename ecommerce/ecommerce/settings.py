...
ALLOWED_HOSTS = ['ecommerce-env.eba-6nmfqxzm.us-west-2.elasticbeanstalk.com']
...
MIDDLEWARE = [
    'account.middleware.DisableBrowserCacheMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'admin_dashboard.context_processor.subject_renderer',
            ],
        },
    },
]
